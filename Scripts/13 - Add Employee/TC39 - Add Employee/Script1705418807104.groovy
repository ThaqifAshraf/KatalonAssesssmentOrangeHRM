...
WebUI.setText(findTestObject('Add Employee (PIM)/Create Employee/Page_OrangeHRM/input_AddEmployeeFirstName'), firstName)

WebUI.setText(findTestObject('Add Employee (PIM)/Create Employee/Page_OrangeHRM/input_AddEmployeeMiddleName'), midName)

WebUI.setText(findTestObject('Add Employee (PIM)/Create Employee/Page_OrangeHRM/input_AddEmployeeLastName'), lastName)
...
WebUI.setText(findTestObject('Add Employee (PIM)/Create Employee/Page_OrangeHRM/input_AddEmployeeID'), ID)

WebUI.click(findTestObject('Add Employee (PIM)/Create Employee/Page_OrangeHRM/btn_switchCreateLogDetails'))

WebUI.setText(findTestObject('Add Employee (PIM)/Create Employee/Page_OrangeHRM/input_AddEmployeeUsername'), userName)
