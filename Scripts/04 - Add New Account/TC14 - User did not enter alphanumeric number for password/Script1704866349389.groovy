...
WebUI.setEncryptedText(findTestObject('Add New Account/TC09 - Add New User/Page_OrangeHRM/input_adduserPassword'), 'vRRrCeg9Qho=')

WebUI.setEncryptedText(findTestObject('Add New Account/TC09 - Add New User/Page_OrangeHRM/input_adduserConfirmPassword'), 
    'vRRrCeg9Qho=')

WebUI.waitForElementPresent(findTestObject('Add New Account/Page_OrangeHRM/appear_Weakpass'), 0)
