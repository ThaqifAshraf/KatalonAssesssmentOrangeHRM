...
WebUI.setText(findTestObject('Add New Account/TC09 - Add New User/Page_OrangeHRM/Username'), 'Test')

WebUI.verifyElementPresent(findTestObject('Add New Account/Page_OrangeHRM/appear_Less5CharUName'), 15)
