...
WebUI.waitForElementPresent(findTestObject('Add New Account/Page_OrangeHRM/appear_Alreadyexistsusername'), 0)

WebUI.verifyElementPresent(findTestObject('Add New Account/Page_OrangeHRM/appear_Alreadyexistsusername'), 0)
