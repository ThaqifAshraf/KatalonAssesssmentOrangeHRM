...
WebUI.setText(findTestObject('Add New Account/TC09 - Add New User/Page_OrangeHRM/Username'), 'IssCassHope')

WebUI.setEncryptedText(findTestObject('Add New Account/TC09 - Add New User/Page_OrangeHRM/input_adduserPassword'), '+oE2JFL33Fg=')

WebUI.verifyElementPresent(findTestObject('Add New Account/Page_OrangeHRM/appear_Less8CharPass'), 0)

WebUI.verifyElementVisible(findTestObject('Add New Account/Page_OrangeHRM/appear_Weakpass'))
