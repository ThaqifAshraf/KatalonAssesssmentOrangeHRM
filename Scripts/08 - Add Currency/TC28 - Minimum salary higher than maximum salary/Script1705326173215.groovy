...
WebUI.setText(findTestObject('Add Pay Grade/Page_OrangeHRM/input_PayGradeName'), 'testLick123')
...
WebUI.setText(findTestObject('Add Currency/Page_OrangeHRM/input_MinSalary'), '1500')

WebUI.setText(findTestObject('Add Currency/Page_OrangeHRM/input_MaxSalary'), '350')

WebUI.verifyElementPresent(findTestObject('Add Currency/Page_OrangeHRM/appear_HigherthanMinSalary'), 0)
