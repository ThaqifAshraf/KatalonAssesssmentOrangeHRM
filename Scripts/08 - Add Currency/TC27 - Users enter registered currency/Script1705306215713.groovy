...
WebUI.setText(findTestObject('Add Pay Grade/Page_OrangeHRM/input_PayGradeName'), 'TestTest')
...
WebUI.scrollToElement(findTestObject('Add Currency/Page_OrangeHRM/ListCurrency_MYR'), 0)
