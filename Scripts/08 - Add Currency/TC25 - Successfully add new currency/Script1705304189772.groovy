...
WebUI.setText(findTestObject('Add Pay Grade/Page_OrangeHRM/input_PayGradeName'), 'test11')
...
WebUI.setText(findTestObject('Add Currency/Page_OrangeHRM/input_MinSalary'), '150')

WebUI.setText(findTestObject('Add Currency/Page_OrangeHRM/input_MaxSalary'), '350')

WebUI.click(findTestObject('Add Currency/Page_OrangeHRM/button_AddCurrencySave'))

WebUI.verifyElementPresent(findTestObject('Add Currency/Page_OrangeHRM/appear_SuccessfullyAdded'), 0)
